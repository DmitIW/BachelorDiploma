...
\newcommand {\byme}{%
\textbf{Гончаров~Иван~Владимирович}%
}

% Научный руководитель #ИСПРАВИТЬ!
\newcommand{\supervisor}%
{к.ф.-м.н., доцент В. В. Махно}
...
\title{\textbf{Разработка и применение алгоритмов определения линейных параметров движущихся объектов методами компьютерного зрения}}
...
\newcommand{\headOfDepartment}{Пилиди В.\,С.}
